                  ...
                  <Grid item xs={12} md={4}>
                    <LightGreenBox
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid Item xs={5}>
                          <WhiteTypography variant="h1">50K*</WhiteTypography>
                        </Grid>
                      </Grid>
                      <Divider
                        variant="middle"
                  ...
                  <Grid item xs={12} md={3}>
                    <StyledBox
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid Item xs={5}>
                          <MainTypography variant="h1">12*</MainTypography>
                        </Grid>
                      </Grid>
                      <Divider
                        variant="middle"
...
function CustomPagination(props) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center" }}>
      <button
        onClick={paginationProps.onPrevPage}
        disabled={!paginationProps.hasPrevPage}>
        Previous
      </button>
      <div style={{ marginLeft: "auto", display: "flex" }}>
        {paginationProps.pageArray.map((page) => (
          <button
            key={page}
            onClick={() => paginationProps.onChangePage(page)}
            style={{
              fontWeight: paginationProps.page === page ? "bold" : "normal",
            }}>
            {page}
          </button>
        ))}
      ...
      <button
        onClick={paginationProps.onNextPage}
